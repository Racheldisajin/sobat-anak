-- SobatAnak Midtrans Official Snap + RajaOngkir Update
-- Import ke database yang SUDAH ADA: sobatanak_db
-- Aman diimport ulang: semua kolom dicek dulu sebelum ditambah.
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `selected_payment_method` varchar(80) DEFAULT 'official_snap',
  `selected_payment_label` varchar(120) DEFAULT 'Midtrans Official Snap',
...
CALL add_sobatanak_col_if_missing('orders', 'selected_payment_method', "varchar(80) DEFAULT 'official_snap' AFTER `payment_type`");
CALL add_sobatanak_col_if_missing('orders', 'selected_payment_label', "varchar(120) DEFAULT 'Midtrans Official Snap' AFTER `selected_payment_method`");
...
CALL add_sobatanak_col_if_missing('user_addresses', 'destination_id', "varchar(30) DEFAULT NULL AFTER `longitude`");
CALL add_sobatanak_col_if_missing('user_addresses', 'district_name', "varchar(120) DEFAULT NULL AFTER `destination_id`");
