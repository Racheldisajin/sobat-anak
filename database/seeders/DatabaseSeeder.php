...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $admin = User::create([
            ...
            'password' => '$2y$12$oA1YpHl0Jajpl0rN8SirieMPkcdTUFht6P.6fOiuM90wa3j1.Ejay',
            'role' => 'admin'
        ]);
        ...
        foreach (['Parenting','Edukasi','Mom Tips','Baby Care','Nutrisi'] as $name) {
            $cats[$name] = PostCategory::create([
                'slug' => Str::slug($name),
                'name' => $name
            ]);
        }

        foreach (['parenting','bayi','mom-tips','edukasi','nutrisi'] as $tag) {
            PostTag::create([
                'slug' => Str::slug($tag),
        ...
        foreach ($posts as $post) {
            Post::create([
                ...
                'counter' => 0,
                'status' => 'published',
                'category_id' => $cats[$post[1]]->id,
                'tags' => $post[2],
                'created_by' => $admin->id,
                'updated_by' => null,
                'published_at' => now(),
                'meta_data' => ['summary' => $post[3]],
                'source' => 'web'
            ]);
        }
        ...
        Testimonial::create([
            'name' => 'Nadia Putri',
            'message' => 'Produknya lengkap dan kualitasnya bagus. Anak saya suka banget sama mainan edukatifnya!'
        ]);

        Testimonial::create([
            'name' => 'Rani Maharani',
            'message' => 'Belanja perlengkapan bayi jadi gampang. Desain websitenya lucu dan mudah dipakai.'
        ]);

        Testimonial::create([
            'name' => 'Dewi Lestari',
            'message' => 'Mini game dan poinnya bikin anak semangat. Voucher belanjanya juga berguna.'
        ]);

        Reward::create([
            'name' => 'Voucher Belanja Rp25.000',
            'points' => 500,
            'description' => 'Tukar poin untuk potongan belanja produk bayi.'
        ]);

        Reward::create([
            'name' => 'Gratis Ongkir',
            'points' => 300,
            'description' => 'Voucher ongkir untuk pembelian berikutnya.'
        ]);

        Reward::create([
            'name' => 'Mystery Gift Anak',
            'points' => 800,
            'description' => 'Hadiah kejutan edukatif untuk si kecil.'
        ]);
    }
}