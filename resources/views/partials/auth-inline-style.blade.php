...
.auth-split-section{position:relative;min-height:calc(100vh - 90px);padding:4.5rem 1.25rem;display:flex;align-items:center;justify-content:center;overflow:hidden;background:linear-gradient(135deg,#F6FCFB 0%,#FFFFFF 45%,#FDECEA 100%);font-family:'Nunito',system-ui,sans-serif;color:#2A3D3C}
...
.auth-split-title{font-size:clamp(2.15rem,4vw,3.55rem);line-height:1;font-weight:1000;color:#2A3D3C;margin:0;font-family:'Nunito',system-ui,sans-serif;letter-spacing:-.04em}
