@extends('layouts.app')
@section('title','Sikat Gigi — SobatAnak')
@section('content')
...
@include('partials.game-point-bridge', ['gameSlug' => 'sikat-gigi'])
@endsection

@push('game_assets')
<link rel="stylesheet" href="{{ asset('games/sikat-gigi/dist/assets/index-Drhl67PB.css') }}">
<script type="module" src="{{ asset('games/sikat-gigi/dist/assets/index-BXz5r4Cx.js') }}"></script>
@endpush
