...
<section class="max-w-7xl mx-auto px-6 md:px-12 py-10">
    ...
    <div class="card p-6 mb-8">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.products.store') }}" class="grid md:grid-cols-2 gap-4">
            ...
            <label class="admin-field-label">Rating Produk
                <input name="rating" type="number" step="0.1" max="5" class="auth-input mt-2" placeholder="Contoh: 4.9">
            </label>
                ...
                <div class="grid gap-3">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.products.update',$product) }}" class="grid gap-3">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <label class="admin-field-label compact">Rating
                                <input name="rating" type="number" step="0.1" value="{{ $product->rating }}" class="auth-input mt-2" placeholder="Rating">
                            </label>
                        </div>
