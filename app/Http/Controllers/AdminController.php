...
use App\Models\{Post,PostCategory,Product,ProductReview,Reward,Testimonial,User,UserPoint,CartItem,RewardClaim};
    ...
    public function dashboard()
    {
        ...
        if (DB::getSchemaBuilder()->hasTable('order_items')) {
            ...
            if (DB::getSchemaBuilder()->hasTable('orders')) {
                ...
                } elseif (DB::getSchemaBuilder()->hasColumn('orders', 'status')) {
            ...
            $createdColumn = DB::getSchemaBuilder()->hasColumn('orders', 'created_at')
                ? 'orders.created_at'
