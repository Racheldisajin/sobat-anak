...
export default function App() {
  ...
  useEffect(() => {
    audioRef.current = new Audio("/sound/backsound.mp3");
      ...
      <div className="home-content">
        <div className="logo-section">
          <div className="brand-logo">
            <img src="/logo-sobat-anak.png" alt="Logo Sobat Anak" className="brand-icon" />
        ...
        <div className="home-illustration">
          ...
          <div className="main-illustration">
            <img src="/logo-game.png" alt="Game Icon" className="illustration-icon" />
          </div>
        </div>
