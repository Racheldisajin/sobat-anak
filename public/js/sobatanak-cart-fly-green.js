...
(function(){
    ...
    function isAddToCartButton(el){
        ...
        // Animasi HANYA untuk tombol/form yang benar-benar menambah ke keranjang.
        // Link detail produk, card produk, dan tombol "Lihat Detail" tidak boleh memicu animasi.
        ...
        // Fallback dibatasi hanya untuk tombol submit pada form /cart/add.
